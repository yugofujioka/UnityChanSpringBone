...
namespace Unity.Animations.SpringBones.Jobs
{
    ...
    public struct SpringBoneJob : IAnimationJob
    {
        ...
        public void ProcessRootMotion(AnimationStream stream)
        {
			...
			rootHandle.GetGlobalTR(stream, out rootPosition, out rootRotation);
			// The root always follow the given position and rotation.
			rootHandle.SetGlobalTR(stream, rootPosition, rootRotation, false);
        }
...
//            }
        ...
        private void UpdateRotation(ref SpringBoneComponent bone, int index, in SpringBoneProperties prop, in TransformQueryCache tc)
        {
            ...
            bone.currentLocalRotation = Quaternion.Slerp(bone.skinAnimationLocalRotation, bone.actualLocalRotation, dynamicRatio);
        }
